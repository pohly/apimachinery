...
type ElasticsearchModificationRequestInterface interface {
	...
	List(opts v1.ListOptions) (*v1alpha1.ElasticsearchModificationRequestList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ElasticsearchModificationRequest, err error)
	ElasticsearchModificationRequestExpansion
}
...
func (c *elasticsearchModificationRequests) List(opts v1.ListOptions) (result *v1alpha1.ElasticsearchModificationRequestList, err error) {
...
func (c *elasticsearchModificationRequests) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *elasticsearchModificationRequests) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
