...
var mysqlmodificationrequestsKind = schema.GroupVersionKind{Group: "dba.kubedb.com", Version: "v1alpha1", Kind: "MySQLModificationRequest"}
...
func (c *FakeMySQLModificationRequests) List(opts v1.ListOptions) (result *v1alpha1.MySQLModificationRequestList, err error) {
	...
	list := &v1alpha1.MySQLModificationRequestList{ListMeta: obj.(*v1alpha1.MySQLModificationRequestList).ListMeta}
	for _, item := range obj.(*v1alpha1.MySQLModificationRequestList).Items {
